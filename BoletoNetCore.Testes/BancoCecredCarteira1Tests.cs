...
namespace BoletoNetCore.Testes
{
    ...
    public class BancoCecredCarteira1Tests
    {
        ...
        public void Cecred_1_BoletoOK(decimal valorTitulo, string nossoNumero, string numeroDocumento, string digitoVerificador, string nossoNumeroFormatado, string codigoDeBarras, string linhaDigitavel, params int[] anoMesDia)
        {
            //Ambiente
