...
namespace BoletoNetCore.Testes
{
    ...
    public class BancoBrasilCarteira17_043Tests
    {
        ...
        {
            Utils.TestarHomologacao(_banco, TipoArquivo.CNAB240, nameof(BancoBrasilCarteira17_043Tests), 5, true, "?", 223344);
        }

        [Test]
        public void Brasil_17_043_REM400()
        {
            Utils.TestarHomologacao(_banco, TipoArquivo.CNAB400, nameof(BancoBrasilCarteira17_043Tests), 5, true, "?", 223344);
        }
        ...
        public void Brasil_17_043_BoletoOK(decimal valorTitulo, string nossoNumero, string numeroDocumento, string digitoVerificador, string nossoNumeroFormatado, string codigoDeBarras, string linhaDigitavel, params int[] anoMesDia)
        {
            //Ambiente
