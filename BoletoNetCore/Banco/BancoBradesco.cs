...
{
    internal sealed class BancoBradesco : BancoFebraban<BancoBradesco> , IBanco
    {
        ...
        protected override string GerarTrailerLoteRemessaCNAB240(ref int numeroRegistroGeral,
