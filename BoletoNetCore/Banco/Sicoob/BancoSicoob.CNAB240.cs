    ...
    partial class BancoSicoob : IBancoCNAB240
    {
        ...
        private string GerarDetalheSegmentoPRemessaCNAB240(Boleto boleto, ref int numeroRegistroGeral)
        {
            try
            {
                ...
                reg.Adicionar(TTiposDadoEDI.ediNumericoSemSeparador_, 0048, 002, 0, string.IsNullOrWhiteSpace(boleto.NumeroDocumento) ? "01" : boleto.NumeroDocumento.Substring(boleto.NumeroDocumento.Length - 2), '0');
