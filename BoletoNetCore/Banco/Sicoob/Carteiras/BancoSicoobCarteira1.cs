...
namespace BoletoNetCore
{
    ...
    internal class BancoSicoobCarteira1: ICarteira<BancoSicoob>
    {
        ...
        public string FormataCodigoBarraCampoLivre(Boleto boleto)
        {
            ...
            return $"{boleto.Carteira}{contaBancaria.Agencia}{boleto.VariacaoCarteira}{beneficiario.Codigo}{beneficiario.CodigoDV}{boleto.NossoNumero}{boleto.NossoNumeroDV}{boleto.NumeroDocumento}";
        }
    }
}
