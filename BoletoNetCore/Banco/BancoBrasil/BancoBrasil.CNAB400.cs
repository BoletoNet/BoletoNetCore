    ...
    partial class BancoBrasil : IBancoCNAB400
    {
        ...
        private string GerarDetalheRemessaCNAB400Registro5Multa(Boleto boleto, ref int numeroRegistroGeral)
        {
            try
            {
                ...
                reg.Adicionar(TTiposDadoEDI.ediAlphaAliDireita______, 0023, 002, 0, boleto.DiasLimiteRecebimento.HasValue ? boleto.DiasLimiteRecebimento.ToString() : string.Empty, ' ');
