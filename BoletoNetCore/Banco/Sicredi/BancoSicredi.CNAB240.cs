    ...
    partial class BancoSicredi : IBancoCNAB240
    {
        ...
        private string GerarDetalheRemessaCNAB240_SegmentoP(Boleto boleto, ref int registro)
        {
            ...
            */
            ...
            reg.Adicionar(TTiposDadoEDI.ediNumericoSemSeparador_, 0225, 003, 0, boleto.DiasBaixaDevolucao, '000'); // 225 a 227 - Nº de dias para baixa/devolução (Manual: "O Sicredi não utiliza esse campo, preencher com zeros")
